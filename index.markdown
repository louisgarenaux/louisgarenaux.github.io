...
His research focuses on the analysis of partial differential equations, with an emphasis on long-time stability of patterns and travelling waves. 

He worked as a post-doctoral researcher at [Karlsruher Institut für Technologie][url-kit] as a member of the [Collaborative Research Center 1173][url-crc]. During summer 2024, he was visiting the [Leiden Mathematisch Instituut][url-leiden]. Beginning 2026, he worked for several months at [INRIA Saclay][url-inria], as a member of the project [Ovopause][url-ovopause].
